        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="m-0">Cập nhật thông tin <b>Sự cố #<?php echo e($issue->id); ?></b></h4>
                </div>
                <div class="card-body p-4">
                    <form action="<?php echo e(route('issues.update', $issue->id)); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reported_by" class="form-control" value="<?php echo e($issue->reported_by); ?>" required maxlength="50">
                        </div>

                        <div class="form-group">
                            <label><b>Thời gian báo cáo</b></label>
                            <input type="datetime-local" name="reported_date" class="form-control" value="<?php echo e(date('Y-m-d\TH:i', strtotime($issue->reported_date))); ?>" required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" class="form-control" required>
                                    <option value="Open" <?php echo e($issue->status == 'Open' ? 'selected' : ''); ?>>Open (Mở)</option>
                                    <option value="In Progress" <?php echo e($issue->status == 'In Progress' ? 'selected' : ''); ?>>In Progress (Đang xử lý)</option>
                                    <option value="Resolved" <?php echo e($issue->status == 'Resolved' ? 'selected' : ''); ?>>Resolved (Đã giải quyết)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" rows="4" required><?php echo e($issue->description); ?></textarea>
                        </div>

                        <div class="text-right mt-4">
                            <a href="<?php echo e(route('issues.index')); ?>" class="btn btn-secondary">Hủy bỏ</a>
...
</html><?php /**PATH C:\xampp\htdocs\CSE485_BTTH04\resources\views/issues/edit.blade.php ENDPATH**/ ?>